...
import { initialValues, validationSchema } from "../CategoryFormAdd/categoryFormSchema"
...
const CategoryFormEdit = ({ onSubmit, category } : Props) => {
    ...
    return (
        <Card title={"Edit Task"} bordered style={{ width: 350 }}>
            <form onSubmit={formMik.handleSubmit}>
                <div>
                    <Typography.Paragraph>{'Task'}</Typography.Paragraph>
                    <Input name={'title'}
